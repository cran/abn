...
load("vienna_pigs.RData") 

## un-compress data-file, which has been saved by:
## save("Abscess.p", "EPcat.p", "HS.p", "MS.p", "PC.p", "PDcat.p", "plbinary.p", "PT.p",
##      "Pyaemia.p", "TAIL.p", file='pigs_post_params.Rds')
load('pigs_post_params.Rds')
dump(list("Abscess.p", "EPcat.p", "HS.p", "MS.p", "PC.p", "PDcat.p", "plbinary.p", "PT.p",
     "Pyaemia.p", "TAIL.p"), 'pigs_post_params.RR')
