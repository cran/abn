...
hillsearchabn <- function(data.df,banned.m,retain.m,start.m,hyper.params=list("mean"=c(0),"sd"=c(sqrt(1000)),"shape"=c(0.001),"scale"=c(1/0.001)),
                          max.parents=NULL,init.permuts=0,num.searches=1,db.size=10000,localdb=TRUE,timing=TRUE,max.iters=100,epsabs=1e-7,error.verbose=FALSE,enforce.db.size=TRUE, std=TRUE) {
