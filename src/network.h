...
void hill_climb_iter(storage *nodescore,cycle *cyclestore,network *dag, network *dag_scratch,network *dag_opt1,network *dag_op2, network *dag_opt3, unsigned int maxparents, 
